describe('user story 1-3 and 1-4', () => {
  it('should show comment correctly', () => {
    cy.visit('https://redrice-frontend.vercel.app/auth/login')
    ...
    cy.wait(7000)
    cy.url().should('eq', 'https://redrice-frontend.vercel.app/')
    cy.wait(7000)
    cy.visit('https://redrice-frontend.vercel.app/restaurant/detail/1')
    ...
    cy.wait(4000)
    cy.visit('https://redrice-frontend.vercel.app/')
    cy.wait(3000)
    cy.visit('https://redrice-frontend.vercel.app/restaurant/detail/2')
