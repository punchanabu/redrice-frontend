...
const Notification = () => {
    return (
        <motion.div
            ...
            id="toast-default"
            className="absolute top-0 left-0 right-0 z-50 flex items-center justify-center w-full mx-auto p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert"
        >
            ...
            <div className="ms-3 text-sm font-normal">Someone message You!</div>
            <button
                type="button"
