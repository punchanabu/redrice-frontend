    ...
    return (
        <div className="w-full h-full flex flex-col relative">
            <div className="h-20 w-full border-b border-slate-300 flex p-1 px-3 items-center gap-4 tablet:gap-6">
                <IoIosArrowBack
                    className="text-3xl text-slate-500 p-1 rounded-full sm:hidden hover:bg-slate-300"
                    onClick={() => setroomid('')}
                />
                {chatData.imageUrl ? (
                    <Image
                ...
                <h1 className="text-md sm:text-2xl font-semibold line-clamp-1">
                    {chatData.name}
                </h1>
                <div
            ...
            {readyChat ? (
                ...
                <Alert severity="error">
                    This is an error Alert. Can't send chat this time
                </Alert>
            )}
